...
boo-cli/0.0.12 darwin-x64 node-v14.4.0
$ boo --help [COMMAND]
USAGE
  $ boo COMMAND
...
...
_See code: [src/commands/index.ts](https://github.com/cli/boo/blob/v0.0.12/src/commands/index.ts)_
...
_See code: [src/commands/jira.ts](https://github.com/cli/boo/blob/v0.0.12/src/commands/jira.ts)_
<!-- commandsstop -->
