...
boo-cli/0.0.7 darwin-x64 node-v14.4.0
$ boo --help [COMMAND]
USAGE
  $ boo COMMAND
...
...
_See code: [src/commands/commit.ts](https://github.com/cli/boo/blob/v0.0.7/src/commands/commit.ts)_
...
_See code: [src/commands/jira.ts](https://github.com/cli/boo/blob/v0.0.7/src/commands/jira.ts)_
<!-- commandsstop -->
